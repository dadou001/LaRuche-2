...
declare module Blockly.Events {
    ...
    class VarCreate extends VarCreate__Class {
        /** The type of the variable like 'int' or 'string'. Does not need to be unique. This will default to "" which is a specific type. */
        varType: string;
        /** The name of the variable. This is unique across variables and procedures. */
        varName: string;
    }
    /** Fake class which should be extended to avoid inheriting static properties */
    ...
    class VarRename extends VarRename__Class {
        /** The current name of the variable. This is unique across variables and procedures. */
        oldName: string;
        /** The new name of the variable. This is unique across variables and procedures. */
        newName: string;
    }
